...
export default function OnboardingScreen() {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7284/ingest/26f413a1-96c6-4f4b-948a-7e5e0bbe3da3',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'219acb'},body:JSON.stringify({sessionId:'219acb',runId:'pre-fix-3',hypothesisId:'H10',location:'apps/mobile/app/onboarding.tsx:34',message:'Onboarding entered',data:{firstSlideImage:slides[0]?.image,slidesCount:slides.length},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
