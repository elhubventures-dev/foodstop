...
export default function PrimeScreen() {
  ...
  // #region agent log
  fetch('http://127.0.0.1:7284/ingest/26f413a1-96c6-4f4b-948a-7e5e0bbe3da3',{method:'POST',headers:{'Content-Type':'application/json','X-Debug-Session-Id':'219acb'},body:JSON.stringify({sessionId:'219acb',runId:'post-fix',hypothesisId:'H9',location:'apps/mobile/app/prime.tsx:16',message:'Prime screen entered',data:{hasPaystackPopup:typeof popup?.checkout === 'function',hasProfile:Boolean(profile)},timestamp:Date.now()})}).catch(()=>{});
  // #endregion
